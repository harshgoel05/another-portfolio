      ...
      <div className="relative h-auto sm:h-auto md:h-90vh">
        ...
        <div className="ml-4 sm:mx-12 md:mx-16 grid grid-cols-12 gap-4 lg:h-90vh place-items-center items-center">
              ...
              <div className="sm:ml-52 xl:ml-96 transform rotate-90">
                <Link href="/work">
                  <img
                    ...
                    alt="Next"
                    className="hidden lg:block w-14 cursor-pointer mt-16 sm:mt-0 transform-all animate-translateright "
                  />
                </Link>
              </div>
            </div>
          ...
          <div className="relative col-span-12 md:col-span-5 lg:col-span-6 flex flex-col">
            <div className="w-64 h-auto shadow-light-xl hover:shadow-light-3xl transform transition-all hover:scale-110 z-auto">
              <TextCards
                heading="Websites"
            ...
            <div className="w-64 h-auto my-4 sm:ml-40 sm:-my-6 lg:ml-60 lg:-my-10 shadow-light-xl hover:shadow-light-3xl transform transition-all hover:scale-110 z-auto">
              <TextCards
                heading="Apps"
